...
func NewCdnConfigurationError(reason string) error {
	return &CdnConfigurationError{
		Reason: reason,
	}
}

func (e *CdnConfigurationError) Error() string {
	return "CdnConfigurationError error: " + e.Reason
}

func (e *CdnConfigurationError) Is(target error) bool {
	var errType *CdnConfigurationError
	return errors.As(target, &errType)
}
...
func RaiseError(errorType, reason string) error {
	...
	case "CdnConfigurationError":
		return NewCdnConfigurationError(reason)
